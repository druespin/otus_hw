...
import ru.otus.web.servlet.client.ClientApiServlet;
import ru.otus.web.servlet.client.ClientsServlet;
...
public class ClientsWebServerSimple implements ClientWebServer {
    ...
    private Server initContext() {
        ...
        handlers.addHandler(applySecurity(servletContextHandler,"/clients", "/api/client/post"));
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new ClientApiServlet(clientDao, gson)), "/api/client/post");
        return servletContextHandler;
    }
}
