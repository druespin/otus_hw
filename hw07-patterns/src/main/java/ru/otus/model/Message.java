...
public class Message {
    ...
    public Message getCopy() {
        Message newMsg = new Message.Builder(this.getId()).build();
        var field13copy = new ObjectForMessage();
        var data13 = this.field13.getData() != null ? this.field13.getData() : new ArrayList<String>();
        field13copy.setData(List.copyOf(data13));
        return newMsg.toBuilder()
                .field1(this.field1)
                .field2(this.field2)
                .field3(this.field3)
                .field4(this.field4)
    ...
    public static class Builder {
        ...
        private Builder(long id, String field1, String field2, String field3, String field4, String field5, String field6,
                        String field7, String field8, String field9, String field10,
                        String field11, String field12, ObjectForMessage field13) {
            this.id = id;
            this.field1 = field1;
